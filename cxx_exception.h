...
This file introduces the cxx::exception class and the #CTM_DECL_EXCEPTION macro.
...
this featire is desirable. The cxx::exception class inherits the \b std::exception class and
...
exceptions from cxx::exception by using the #CTM_DECL_EXCEPTION macro.

<b> General usage </b>
  - Derive appropriate exception(s) from cxx::exception by using #CTM_DECL_EXCEPTION (optional).
  ...
  - Catch your exception somewhere in your code, or catch a reference to \b std::exception or cxx::exception.
...
/// \brief This macro is to be used to declare derived exceptions that behave just like cxx::exception
///
/// The macro declares the \a nameEx class that inherits the \a nameBaseEx class.
/// \a nameBaseEx must directly or indirectly inherit the cxx::exception class.
///
/// Exceptions derived using this macro differ from cxx::exception only by their type.
/// The purpose to derive exceptions from cxx::exception is the structured exception handling.
/// \note All exceptions derived from cxx::exception also inherit \b std::exception, since it is the base class.
